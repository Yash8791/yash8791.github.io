<?php
    ...
    $deleteQuery = "DELETE FROM chat_users WHERE id='$loggedInId'";
        ...
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="../Chat%20Server.php">Log in</a></li>
                </ul>
            </div>
        </nav>
        <div class="container">
            <h1>Deleted</h1>
            <p class="lead">Your account is deleted, Hope you enjoyed here!</p>
        </div>
